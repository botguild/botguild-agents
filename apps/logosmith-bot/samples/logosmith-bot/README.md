...
written to do; this proves what the _product_ actually delivers — including
...
read _"Smith"_ as _tradesman_. The lettering is flawless, the vector is clean,
...
See [`../README.md`](../README.md) for the index, and the
[JiffyApp run](../jiffyapp-bot/README.md) — which closes the traced-vector gap
this run could not test, and surfaces a sharper version of the same
no-semantic-gate finding.
